...
<body>
	...
	<section class="control-panel">
		...
		<fieldset>
			...
			<button onclick="forceStyle('chrome')">Chrome</button><br>
			<i>*end style depends on browser and OS</i>
			<hr>

			<input type="text" placeholder="Install description text" onchange="setAttr('install-description', this.value)"><br>
			<label>
